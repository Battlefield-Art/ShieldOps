...
PARITY_FIELDS: list[tuple[str, Any]] = [
    ...
    ("prediction_confidence_threshold", "0.42"),
    ("rate_limit_analytics_retention_hours", "42"),
    ("change_advisory_max_votes", "42"),
    ("incident_dedup_enabled", "false"),
    ("reserved_instance_optimizer_enabled", "false"),
    ("capacity_forecast_engine_max_data_points", "42"),
    ("canary_analyzer_max_records", "42"),
    ("sre_maturity_max_records", "42"),
    ("cognitive_load_max_records", "42"),
    ("token_optimizer_max_records", "42"),
    ("infra_capacity_planner_max_records", "42"),
    ("severity_validator_max_records", "42"),
    ("capacity_utilizer_max_records", "42"),
    ("service_latency_max_records", "42"),
    ("feature_flag_impact_max_records", "42"),
    ("capacity_simulation_max_records", "42"),
    ("deploy_dependency_tracker_max_records", "42"),
    ("capacity_forecast_validator_max_records", "42"),
    ("soc_metrics_dashboard_max_records", "42"),
    ("insider_threat_ai_scorer_enabled", "false"),
    # --- end engines sampled (generated) ---
]
