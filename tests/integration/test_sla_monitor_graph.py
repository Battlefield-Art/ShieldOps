...
from shieldops.agents.sla_monitor.models import MonitorStage, SLAMonitorState


@pytest.fixture
def state() -> dict:
    return SLAMonitorState(
        request_id="test-sm-001", tenant_id="t-01", session_start=1e6
    ).model_dump()
