...
@pytest.fixture
def state() -> dict:
    return NetworkSegmentationState(request_id="test-ns-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["discover_zones", "map_traffic", "detect_violations", "assess_risk", "enforce_policies", "generate_report"]:
