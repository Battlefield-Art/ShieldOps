...
@pytest.fixture
def state() -> dict:
    return ConfigValidatorState(request_id="test-cv-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["collect_configs", "compare_baselines", "detect_drift", "assess_impact", "remediate", "generate_report"]:
