...
import pytest
from shieldops.agents.log_analyzer.models import LogAnalyzerState, AnalyzerStage

@pytest.fixture
def state() -> dict:
    return LogAnalyzerState(request_id="test-la-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["collect_logs", "parse_patterns", "detect_anomalies", "correlate_events", "alert", "generate_report"]:
