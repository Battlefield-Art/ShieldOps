...
@pytest.fixture
def state() -> dict:
    return WorkflowEngineState(request_id="test-we-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["load_workflow", "validate", "execute_steps", "check_gates", "finalize", "generate_report"]:
