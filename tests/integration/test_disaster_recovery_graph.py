...
@pytest.fixture
def state() -> dict:
    return DisasterRecoveryState(request_id="test-dr-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["assess_plans", "test_failover", "measure_rto_rpo", "identify_gaps", "remediate", "generate_report"]:
