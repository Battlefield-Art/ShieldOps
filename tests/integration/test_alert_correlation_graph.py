...
@pytest.fixture
def state() -> dict:
    return AlertCorrelationState(request_id="test-ac-001", tenant_id="t-01", session_start=1e6).model_dump()
...
def test_graph_compiles():
    ...
    for name in ["collect_alerts", "normalize", "correlate", "build_chains", "prioritize", "generate_report"]:
