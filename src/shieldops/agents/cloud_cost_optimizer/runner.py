"""Cloud Cost Optimizer Agent — Entry point and lifecycle."""
...
class CloudCostOptimizerRunner:
    """Runs the Cloud Cost Optimizer workflow."""
    ...
    def __init__(
        ...
        self._toolkit = CloudCostOptimizerToolkit(
    ...
    async def execute(
        ...
        try:
            ...
            logger.exception("cco_runner.execute.error")
            raise
