"""Security Knowledge Graph Agent — Entry point and lifecycle."""
...
class SecurityKnowledgeGraphRunner:
    """Runs the Security Knowledge Graph workflow."""
    ...
    async def execute(
        ...
        """Execute security knowledge graph workflow."""
        ...
        try:
            ...
            logger.exception("skg_runner.execute.error")
            raise
        ...
        return [
            {
                ...
                "entities": r.get("total_entities", 0),
                "relationships": r.get(
                    "total_relationships",
                    0,
                ),
