"""Threat Feed Aggregator Agent runner."""
...
class ThreatFeedAggregatorRunner:
    """Runs threat feed aggregation workflows."""
    ...
    def __init__(
        ...
        graph = create_threat_feed_aggregator_graph()
    ...
    async def execute(
        ...
        """Run a full feed aggregation workflow."""
        rid = f"tfa-{uuid4().hex[:8]}"
        logger.info(
            "tfa_run_started",
            request_id=rid,
            tenant_id=tenant_id,
