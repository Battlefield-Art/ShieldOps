...
```
shieldops/
├── agents/          # 151 LangGraph agents (see agents/CLAUDE.md)
├── api/             # FastAPI routes + middleware (see api/CLAUDE.md)
├── security/        # 400+ security engines (see security/CLAUDE.md)
├── observability/   # 200+ OTel/telemetry engines (see observability/CLAUDE.md)
├── analytics/       # 250+ analytics engines (see analytics/CLAUDE.md)
├── operations/      # 160+ ops engines (see operations/CLAUDE.md)
├── compliance/      # 100+ compliance engines (see compliance/CLAUDE.md)
├── connectors/      # 17 vendor connectors (see connectors/CLAUDE.md)
