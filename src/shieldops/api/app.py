    ...
    if session_factory:
        try:
            ...
            for atype in (
                ...
                "data_resilience",
                "managed_threat_hunting",
                "vulnerability_intelligence",
                "file_integrity_monitor",
                "iot_ot_security",
                "security_app_builder",
                "air_gap_vault",
                "agent_memory_store",
                "reflection_engine",
                "evolution",
                ...
                "situation_manager",
                "trust_relationship_mapper",
                "it_asset_intelligence",
                "ai_runtime_guardian",
                "data_intelligence",
                "endpoint_dlp",
                ...
                "detection_gap_finder",
                "security_scorecard",
                "compliance_gap_analyzer",
                "attack_readiness_assessor",
                "executive_reporter",
                "security_pipeline",
                "finding_correlator",
                "auto_ticket_manager",
                "continuous_scanner",
                "risk_prioritizer",
                "security_dashboard_aggregator",
                "apt_emulator",
                "purple_team_orchestrator",
                "threat_scenario_runner",
...
def create_app() -> FastAPI:
    ...
    for _rname in (
        ...
        "sox_auditor",
        "iso27001_assessor",
        "nist_framework_mapper",
        "model_drift_detector",
        "training_data_validator",
        "inference_attack_detector",
        "model_explainability_auditor",
        "ai_bias_scanner",
        "federated_learning_security",
        "physical_access_monitor",
        "cctv_analytics",
        "environmental_monitor",
        "scada_security_analyzer",
        "industrial_protocol_analyzer",
        "building_management_security",
        "dark_web_monitor",
        "brand_protection_scanner",
        "threat_landscape_mapper",
        "kill_chain_analyzer",
        "adversary_emulator",
        "hunt_hypothesis_generator",
        "alert_enrichment_engine",
        "ticket_automation",
        "shift_handoff_manager",
        "soc_metrics_dashboard",
        "playbook_optimizer",
        "war_gaming_simulator",
        "data_masking_engine",
        "tokenization_manager",
        "privacy_impact_assessor",
        "data_lineage_tracker",
        "consent_manager",
        "data_breach_responder",
        "zero_trust_validator",
        "micro_segmentation_planner",
        "security_architecture_reviewer",
        "threat_surface_minimizer",
        "defense_in_depth_auditor",
        "security_control_mapper",
        "vendor_risk_assessor",
        "sbom_analyzer",
        "dependency_graph_analyzer",
        "open_source_license_scanner",
        "artifact_integrity_checker",
        "ci_cd_security_auditor",
        "mfa_compliance_checker",
        "orphan_account_detector",
        "permission_creep_analyzer",
        "just_in_time_access",
        "credential_rotation_manager",
        "privileged_session_recorder",
        "incident_prediction_engine",
        "incident_cost_calculator",
        "incident_similarity_engine",
