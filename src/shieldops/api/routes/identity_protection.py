"""Identity protection API routes."""
...
router = APIRouter(prefix="/identity-protection", tags=["Identity Protection"])
_runner: Any = None
...
def _get_runner() -> Any:
    if _runner is None:
        raise HTTPException(503, "identity_protection service unavailable")
    return _runner
...
async def run_agent(
    ...
    try:
        ...
        logger.exception("identity_protection.run.error")
