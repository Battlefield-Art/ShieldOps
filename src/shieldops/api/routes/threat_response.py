...
def _get_runner() -> Any:
    if _runner is None:
        raise HTTPException(503, "threat_response service unavailable")
    return _runner
...
async def run_agent(
    ...
    try:
        ...
        logger.exception("threat_response.run.error")
