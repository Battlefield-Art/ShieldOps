...
export default function BrowserIsolation() {
  ...
  return (<div className="space-y-6">
    <PageHeader title="Browser Isolation" subtitle="Isolated browsing sessions and policy management" icon={<Globe className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Monitored" value="1,247" icon={<Globe className="h-5 w-5" />} />
