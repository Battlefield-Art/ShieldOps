...
export default function DeploymentGuardian() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Deployment Guardian" subtitle="Pre-deployment security gates and rollout monitoring" icon={<Shield className="h-6 w-6" />} />
