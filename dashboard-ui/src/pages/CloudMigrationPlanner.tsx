...
export default function CloudMigrationPlanner() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Cloud Migration" subtitle="Workload assessment and migration wave planning" icon={<Shield className="h-6 w-6" />} />
