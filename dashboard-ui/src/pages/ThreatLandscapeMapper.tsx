...
import { Globe, Shield, BarChart3, AlertTriangle } from "lucide-react";
...
export default function ThreatLandscapeMapper() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Threat Landscape" subtitle="Automated security analysis" icon={<Globe className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Scans" value="156" icon={<Globe className="h-5 w-5" />} />
