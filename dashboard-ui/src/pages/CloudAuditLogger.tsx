...
import { FileText, Shield, BarChart3, AlertTriangle } from "lucide-react";
...
export default function CloudAuditLogger() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Cloud Audit Logger" subtitle="CloudTrail GCP Azure audit log analysis" icon={<FileText className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Resources" value="892" icon={<FileText className="h-5 w-5" />} />
