...
export default function APIGatewaySecurity() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="API Gateway Security" subtitle="Endpoint security and abuse detection" icon={<Shield className="h-6 w-6" />} />
