...
export default function ThreatFeedAggregator() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="ThreatFeedAggregator" subtitle="Multi-source threat intelligence feed aggregation" icon={<Shield className="h-6 w-6" />} />
