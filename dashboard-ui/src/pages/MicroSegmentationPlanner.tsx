...
export default function MicroSegmentationPlanner() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Micro Segmentation" subtitle="Automated security analysis" icon={<Network className="h-6 w-6" />} />
