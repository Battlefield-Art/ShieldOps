...
export default function CloudStorageScanner() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Cloud Storage Scanner" subtitle="S3 GCS Blob bucket security scanning" icon={<Database className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Resources" value="892" icon={<Database className="h-5 w-5" />} />
