...
export default function IncidentEscalationEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Incident Escalation" subtitle="Severity-based escalation and responder notification" icon={<Shield className="h-6 w-6" />} />
