...
export default function DependencyGraphAnalyzer() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Dependency Graph" subtitle="Automated security analysis" icon={<GitBranch className="h-6 w-6" />} />
