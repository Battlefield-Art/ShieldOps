    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 rounded-lg border border-white/[0.1] bg-surface-3 px-4 py-2 text-sm font-medium text-gray-200 hover:bg-white/[0.06]">
      ...
      <div className="overflow-hidden rounded-xl border border-white/[0.06] bg-surface-2 shadow-card">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/[0.04] text-left text-gray-400">
            ...
            <tbody className="divide-y divide-gray-800/40">
              {MOCK_SERVICES.map((svc) => (
                <tr key={svc.name} className="text-gray-300 hover:bg-surface-3/30">
