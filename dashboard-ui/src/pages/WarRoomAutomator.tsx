...
export default function WarRoomAutomator() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="War Room Automator" subtitle="Automated incident war room creation and coordination" icon={<Shield className="h-6 w-6" />} />
