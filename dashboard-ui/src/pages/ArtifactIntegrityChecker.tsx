...
export default function ArtifactIntegrityChecker() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Artifact Integrity" subtitle="Automated security analysis" icon={<CheckCircle className="h-6 w-6" />} />
