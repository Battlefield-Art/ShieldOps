...
export default function ThreatHuntAutomation() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="ThreatHuntAutomation" subtitle="Hypothesis-driven automated threat hunting" icon={<Shield className="h-6 w-6" />} />
