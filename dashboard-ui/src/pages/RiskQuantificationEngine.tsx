...
export default function RiskQuantificationEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="RiskQuantificationEngine" subtitle="FAIR-based cyber risk quantification" icon={<Shield className="h-6 w-6" />} />
