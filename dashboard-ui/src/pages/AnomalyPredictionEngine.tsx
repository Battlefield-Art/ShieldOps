...
export default function AnomalyPredictionEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Anomaly Prediction" subtitle="ML-based predictive anomaly detection" icon={<Shield className="h-6 w-6" />} />
