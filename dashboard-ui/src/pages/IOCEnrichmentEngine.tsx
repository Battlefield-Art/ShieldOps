...
export default function IOCEnrichmentEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="IOCEnrichmentEngine" subtitle="Automated IOC enrichment and context correlation" icon={<Shield className="h-6 w-6" />} />
