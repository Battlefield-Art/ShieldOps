                  ...
                  <div className="mt-6">
                    {tier.monthlyPrice !== null ? (
                      ...
                      <a
                        ...
                        className="block rounded-lg border border-gray-700 px-4 py-2.5 text-center text-sm font-medium text-gray-300 transition-all hover:border-gray-500 hover:bg-gray-800/50 hover:text-white"
                      >
                        {tier.cta}
                      </a>
                    )}
      ...
      <section className="px-6 py-16">
        <div className="mx-auto max-w-2xl rounded-2xl border border-gray-800 bg-gray-900 p-8 text-center sm:p-12">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href="mailto:founders@shieldops.io"
              className="rounded-lg border border-gray-700 px-6 py-3 text-sm font-medium text-gray-300 transition-all hover:border-gray-500 hover:bg-gray-800/50 hover:text-white"
            >
              Talk to Sales
            </a>
          </div>
