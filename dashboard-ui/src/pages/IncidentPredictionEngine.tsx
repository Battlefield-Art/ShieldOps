...
export default function IncidentPredictionEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Incident Prediction" subtitle="Automated security analysis" icon={<TrendingUp className="h-6 w-6" />} />
