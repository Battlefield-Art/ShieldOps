...
export default function PerformanceBaselineEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Performance Baselines" subtitle="Automated baseline and regression detection" icon={<Shield className="h-6 w-6" />} />
