...
export default function DataRetentionEnforcer() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Data Retention" subtitle="Automated data lifecycle and retention enforcement" icon={<Shield className="h-6 w-6" />} />
