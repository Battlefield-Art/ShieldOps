...
import { Boxes, Shield, BarChart3, CheckCircle } from "lucide-react";
...
export default function ContainerImageScanner() {
  ...
  return (<div className="space-y-6">
    <PageHeader title="Image Scanner" subtitle="Container image scanning" icon={<Boxes className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Scans Run" value="24" icon={<Boxes className="h-5 w-5" />} />
