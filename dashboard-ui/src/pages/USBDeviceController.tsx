...
import { HardDrive, Shield, BarChart3, AlertTriangle } from "lucide-react";
...
export default function USBDeviceController() {
  ...
  return (<div className="space-y-6">
    <PageHeader title="USB Device Controller" subtitle="USB device whitelisting and monitoring" icon={<HardDrive className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Monitored" value="1,247" icon={<HardDrive className="h-5 w-5" />} />
