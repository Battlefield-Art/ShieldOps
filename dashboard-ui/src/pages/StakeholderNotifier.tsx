...
export default function StakeholderNotifier() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Stakeholder Notifier" subtitle="Multi-channel stakeholder impact notification" icon={<Shield className="h-6 w-6" />} />
