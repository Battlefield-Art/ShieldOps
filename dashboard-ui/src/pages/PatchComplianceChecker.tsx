...
export default function PatchComplianceChecker() {
  ...
  return (<div className="space-y-6">
    <PageHeader title="Patch Compliance" subtitle="Fleet-wide patch compliance and SLA tracking" icon={<CheckCircle className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Monitored" value="1,247" icon={<CheckCircle className="h-5 w-5" />} />
