...
export default function ConfigurationAuditor() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Configuration Auditor" subtitle="Config drift detection and security validation" icon={<Shield className="h-6 w-6" />} />
