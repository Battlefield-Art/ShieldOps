...
export default function ModelDriftDetector() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Model Drift Detector" subtitle="Automated security analysis and monitoring" icon={<TrendingUp className="h-6 w-6" />} />
