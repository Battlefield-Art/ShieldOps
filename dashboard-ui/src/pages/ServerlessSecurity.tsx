...
export default function ServerlessSecurity() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Serverless Security" subtitle="Lambda Cloud Functions security analysis" icon={<Zap className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Resources" value="892" icon={<Zap className="h-5 w-5" />} />
