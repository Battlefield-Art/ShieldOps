...
export default function ResponseAutomationEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="ResponseAutomationEngine" subtitle="Automated incident response orchestration" icon={<Shield className="h-6 w-6" />} />
