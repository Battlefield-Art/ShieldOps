...
export default function SecurityAwarenessTrainer() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="SecurityAwarenessTrainer" subtitle="AI-generated security training campaigns" icon={<Shield className="h-6 w-6" />} />
