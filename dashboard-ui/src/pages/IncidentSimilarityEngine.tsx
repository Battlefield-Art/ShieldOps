...
export default function IncidentSimilarityEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Incident Similarity" subtitle="Automated security analysis" icon={<Layers className="h-6 w-6" />} />
