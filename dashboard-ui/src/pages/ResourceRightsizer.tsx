...
export default function ResourceRightsizer() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Resource Rightsizer" subtitle="Utilization-based rightsizing recommendations" icon={<Shield className="h-6 w-6" />} />
