...
export default function VendorComplianceAssessor() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Vendor Compliance" subtitle="Third-party vendor risk and compliance assessment" icon={<Shield className="h-6 w-6" />} />
