...
export default function ServiceDependencyMapper() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Service Dependencies" subtitle="Dynamic service mesh dependency mapping" icon={<Shield className="h-6 w-6" />} />
