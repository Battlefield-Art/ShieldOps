...
export default function RegulatoryChangeTracker() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Regulatory Changes" subtitle="Automated regulatory change tracking and impact assessment" icon={<Shield className="h-6 w-6" />} />
