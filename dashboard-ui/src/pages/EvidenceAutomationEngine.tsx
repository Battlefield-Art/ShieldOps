...
export default function EvidenceAutomationEngine() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="Evidence Automation" subtitle="Automated compliance evidence collection and validation" icon={<Shield className="h-6 w-6" />} />
