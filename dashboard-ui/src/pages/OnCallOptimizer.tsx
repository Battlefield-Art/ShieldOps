...
export default function OnCallOptimizer() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="On-Call Optimizer" subtitle="Schedule optimization and burnout prevention" icon={<Shield className="h-6 w-6" />} />
