...
export default function FinopsForecaster() {
  const [tab, setTab] = useState<TabId>("overview");
  return (<div className="space-y-6">
    <PageHeader title="FinOps Forecaster" subtitle="Historical cost forecasting and budget recommendations" icon={<Shield className="h-6 w-6" />} />
