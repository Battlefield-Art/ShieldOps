...
import { CheckCircle, Shield, BarChart3, AlertTriangle } from "lucide-react";
...
export default function ConsentManager() {
  ...
  return (<div className="space-y-6">
    <PageHeader title="Consent Manager" subtitle="Automated security analysis" icon={<CheckCircle className="h-6 w-6" />} />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      <MetricCard title="Scans" value="156" icon={<CheckCircle className="h-5 w-5" />} />
