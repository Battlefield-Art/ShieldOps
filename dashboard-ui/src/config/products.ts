...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/api-token-rotator", icon: Key, label: "Token Rotator" },
      { to: "/app/security-signal-correlator", icon: Radio, label: "Signal Correlator" },
      { to: "/app/cloud-billing-protector", icon: DollarSign, label: "Billing Protector" },
      ...
      { to: "/app/cloud-permission-optimizer", icon: Lock, label: "Perm Optimizer" },
      { to: "/app/security-event-enricher", icon: Zap, label: "Event Enricher" },
      { to: "/app/vulnerability-scanner-orchestrator", icon: Bug, label: "Vuln Scanner Orch" },
      { to: "/app/security-alert-router", icon: ShieldAlert, label: "Alert Router" },
      { to: "/app/cloud-database-protector", icon: Database, label: "DB Protector" },
      { to: "/app/security-training-tracker", icon: BookOpen, label: "Training Tracker" },
