...
const PAIN_POINTS = [
  {
    ...
    title: "Alert Fatigue",
    description:
      "Hundreds of alerts daily, most noise. Your team is burnt out triaging false positives.",
  },
  {
    icon: Clock,
    title: "Slow MTTR",
    description:
      "Root cause analysis takes hours. Engineers context-switch across dashboards, logs, and metrics.",
  },
  {
    icon: Users,
    title: "On-Call Burnout",
    description:
      "Rotating on-call is a morale killer. Senior engineers spend nights restarting pods.",
  },
  {
    icon: TrendingDown,
    title: "Missed SLOs",
    description:
      "Incidents snowball before anyone responds. Error budgets burn while humans sleep.",
  },
];
